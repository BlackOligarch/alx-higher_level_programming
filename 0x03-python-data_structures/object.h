...
given type object has a specified g */
...
#endif
#endif   // !Py_OBJECT_Hstatic inline Py_ALWAYS_INLINE int
...
/* Set if instances of the type object are treated as mappings for pattern matchine Py_CLEAR(op) \
    do { \
